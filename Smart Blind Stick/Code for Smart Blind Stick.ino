...
void setup() 
{
  ...
  Serial.begin(9600); // Starts the serial monitor. Serial monitor is set to 9600 baud
}
...
void loop() 
{
  ...
  safetyDistance = distance; 
   if (safetyDistance <= 5)
   {
    ...
    // The distance is displayed on the Serial Monitor. Serial Monitor is set to 9600 baud
